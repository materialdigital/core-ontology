...
sh run.sh robot reason  --catalog catalog-v001.xml --reasoner hermit --axiom-generators "SubClass SubObjectProperty ClassAssertion InverseObjectProperties PropertyAssertion" --input pmdco-edit.owl query --update utils/remove-isabout.sparql --output ./tmp/tmp-reasoned.ttl
