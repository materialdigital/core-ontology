...
sh run.sh robot --catalog catalog-v001.xml merge --input pmdco-edit.owl reason --reasoner hermit --axiom-generators "SubClass SubObjectProperty ClassAssertion InverseObjectProperties PropertyAssertion" query --update utils/remove-isabout.sparql --output ./tmp/tmp-reasoned.ttl
