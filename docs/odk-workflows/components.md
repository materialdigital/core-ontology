...
```
  <uri name="https://w3id.org/pmd/co/pmdco/components/your-component-name.owl" uri="components/your-component-name.owl"/>
```

4) Add the component to the edit file (src/ontology/pmdco-edit.obo)
for .obo formats: 

```
import: https://w3id.org/pmd/co/pmdco/components/your-component-name.owl
```
...
6) In your custom makefile (src/ontology/pmdco.Makefile) add a goal for your custom make file. In this example, the goal is a ROBOT template.
