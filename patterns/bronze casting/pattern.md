- **Purpose**: Detailed examples of process sequence with temporally qualified continuants as well as changing qualities over time.
...
- **Description**: In summary, the pattern models a coherent sequence of metallurgical activities:
