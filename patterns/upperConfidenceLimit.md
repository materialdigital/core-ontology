# Pattern 1: upper confidence limit composed of value specification
## Purpose
Description on how to represent upper confidence limit of a measurement.

## Description
upper confidence limit is a data item which is a lowest value bounding a confidence interval.
...
## Visualization
The following image shows upper confidence limit of the measurement of quality Speed.

<img src="https://github.com/materialdigital/core-ontology/blob/develop-3.0.0/patterns/upperConfidenceLimit-Example.png?raw=true" alt="LowerConfidenceLimit image" width="750"/>

## Shapes and example data
[../shapes/upperConfidenceLimit-data.ttl](../shapes/upperConfidenceLimit-data.ttl)

[../shapes/upperConfidenceLimit.ttl](../shapes/upperConfidenceLimit.ttl)
